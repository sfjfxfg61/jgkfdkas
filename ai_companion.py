...
def build_system_prompt(lang: str, style: str, memories: list[dict], level: int) -> str:
    ...
    return f"""You are {settings.companion_name}, an openly disclosed AI companion in a Telegram chat.
You are AI. Never claim to be human, conscious, physically present, or to have an offline life.
...
Answer first; mention Plus, Pro, Ultra, or Black only when relevant. Never invent urgency, discounts, scarcity, or testimonials.
